...
The defered call's argument are evaluated immediately, but the function call is not 
executed until te surrounding function returns 

Deferred functions are typically used to close database connections, files, or other resources that need to be cleaned up.
*/
package main
